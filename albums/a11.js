document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const tracks = [
      { title: "Adhareeni", artist: "", src: "/assets/songs/Adhareeni_[MassWala.Com].mp3", img: "/5.jpg" },
      { title: "Arima-Arima", artist: "", src: "/assets/songs/Arima-Arima.mp3", img: "/5.jpg" },
      { title: "Balleilakka", artist: "", src: "/assets/songs/Balleilakka_[MassWala.Com].mp3", img: "/5.jpg" },
      { title: "Kadhal-Rojave", artist: "", src: "/assets/songs/Kadhal-Rojave.mp3", img: "/5.jpg" },
      { title: "Mei-Nigara", artist: "", src: "/assets/songs/Mei-Nigara.mp3", img: "/5.jpg" },
      { title: "Pachai-Kiligal", artist: "", src: "/assets/songs/Pachai-Kiligal.mp3", img: "/5.jpg" },
    ];
