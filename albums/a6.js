document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const tracks = [
      { title: "Manasilayo", artist: "Vettaiyan", src: "/assets/songs/Manasilayo.mp3", img: "/16.jpg" },
      { title: "Clean Shot", artist: "Vettaiyan", src: "/assets/songs/Clean Shot.mp3", img: "/16.jpg" },
      { title: "Hunter Vantaar", artist: "Vettaiyan", src: "/assets/songs/Hunter Vantaar.mp3", img: "/16.jpg" },
    ];
