document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const tracks = [
      { title: "Valayapatti", artist: "AZHAGIYA TAMIL MAGAN", src: "/assets/songs/Valayapatti.mp3", img: "/14.jpg" },
      { title: "Maduraikku", artist: "AZHAGIYA TAMIL MAGAN", src: "/assets/songs/Maduraikku.mp3", img: "/14.jpg" },
      { title: "Ella Pugazhum", artist: "AZHAGIYA TAMIL MAGAN", src: "/assets/songs/Ella-Pugazhum.mp3", img: "/14.jpg" },
    ];
