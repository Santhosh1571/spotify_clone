document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const tracks = [
      { title: "Enna Solla Pogirai", artist: "Kandukondain-Kandukondain", src: "/assets/songs/Enna-Solla-Pogirai.mp3", img: "/13.jpg" },
      { title: "Enge Enathu Kavithai", artist: "Kandukondain-Kandukondain", src: "/assets/songs/Enge-Enathu-Kavithai.mp3", img: "/13.jpg" },
      { title: "Kandukondain-Kandukondain", artist: "Kandukondain-Kandukondain", src: "/assets/songs/Kandukondain-Kandukondain.mp3", img: "/13.jpg" },
    ];
