document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const tracks = [
      { title: "Kandangi-Kandangi", artist: "Jilla", src: "/assets/songs/Kandangi-Kandangi.mp3", img: "/15.jpg" },
      { title: "Verasa-Pogaiyile", artist: "Jilla", src: "/assets/songs/Verasa-Pogaiyile.mp3", img: "/15.jpg" },
      { title: "Pattu-Onnu", artist: "Jilla", src: "/assets/songs/Pattu-Onnu.mp3", img: "/15.jpg" },
    ];
