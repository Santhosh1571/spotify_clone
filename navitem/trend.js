document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const tracks = [
      ...
      { title: "Dheema Dheema", artist: "LIC", src: "/assets/songs/Dheema-MassTamilan.dev.mp3", img: "2.jpg" },
      { title: "Fear Song", artist: "Devara", src: "/assets/songs/Fear Song.mp3", img: "3.jpg" },
      { title: "Golden Sparrow", artist: "Nilavukku en mel ennadi kovam", src: "/assets/songs/Golden-Sparrow (1).mp3", img: "4.jpg" },
      { title: "Manasilayo", artist: "Vettaiyan", src: "/assets/songs/Manasilayo.mp3", img: "5.jpg" },
