document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const tracks = [
      { title: "Hey Minnale", artist: "Amaran", src: "/assets/songs/Hey Minnale.mp3", img: "1.jpg" },
      { title: "Fear Song", artist: "Devara", src: "/assets/songs/Fear Song.mp3", img: "2.jpg" },
      { title: "Andhi Vaanil", artist: "ARM", src: "/assets/songs/Andhi Vaanil.mp3", img: "3.jpg" },
      { title: "Manasilayo", artist: "Vettaiyan", src: "/assets/songs/Manasilayo.mp3", img: "4.jpg" },
      { title: "Golden-Sparrow", artist: "Nilavuku en mel ennadi kovam", src: "/assets/songs/Golden-Sparrow (1).mp3", img: "5.jpg" },
